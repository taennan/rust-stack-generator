    ...
    ($db:ident, $entity_model:ident, $db_model:ident, $input:ident) => {
        mod create {
            ...
            async fn it_returns_newly_created_model() {
                ...
                let connection = crate::utils::client_tests::mock_query_connection(queried_results);
...
macro_rules! delete_by_id_tests {
    ($db:ident) => {
        mod delete_by_id {
            use super::*;
            ...
            async fn it_returns_ok_on_successful_deletion() {
                ...
                let connection = crate::utils::client_tests::mock_exec_connection(execution_result);
...
pub(crate) use create_tests;
pub(crate) use delete_by_id_tests;
pub(crate) use get_one_tests;
pub(crate) use update_tests;
